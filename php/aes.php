...
//$enc = Crypto::encrypt_file('test.txt', 'secret', true, true);
//echo $enc . "\n";
$dec = Crypto::decrypt_file("e-hAzXSPJpNVA8FquedtbGc5NVYNHLqNqitCGtiKpLQqGR3_ZhngyHAWBZjuvOx9.enc", "secret", true);
echo $dec . "\n";
